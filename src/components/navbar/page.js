...
const Navbar = () => {
    ...
    // useEffect ile DOM manipülasyonu yapabilirsiniz
    useEffect(() => {
        ...
        const handleClickOutside = (e) => {
            ...
            if (!e.target.closest('.dropdown')) {
                setIsOpen(false); // Menü dışına tıklanırsa menüyü kapat
            }
        };

        const toggleMenu = () => {
            console.log("toggleMenu");
            setIsOpen((prev) => !prev); // Menü açma/kapama
        };

        menuButton.addEventListener('click', toggleMenu);
        window.addEventListener('click', handleClickOutside);

        // Cleanup: Komponent unmount olduğunda event listener'ları temizle
        return () => {
            ...
            <nav className="bg-gray-800">
                <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                    <div className="relative flex h-16 items-center justify-between">
                        <div className="relative inline-block text-left dropdown absolute inset-y-0 left-0 flex items-center sm:hidden">
                            <button id="menuButton" type="button" className="relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
                            ...
                            {isOpen && (
                                <div className="sm:hidden">
                                    <div id="dropdownMenu" className="space-y-1 px-2 pb-3 pt-2">
                        ...
                        <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                            ...
                            <div id="dropdownMenu" className="hidden sm:ml-6 sm:block">
